...
<div class="item"  id=<?php echo "\"".$result[$i]['bookid']."\"";?>  onclick="showDesc(this.id)">
  ...
  <div class="desc">
    ...
    <div class="dete" >
      ...
      <a href="<?php echo "download_increment.php";?>?a=increase&id=<?php echo $result[$i]['bookid']?>&url=<?php echo $result[$i]['pdfURL']?>&<?php echo $_SERVER['QUERY_STRING']?>">Download Now</a>
